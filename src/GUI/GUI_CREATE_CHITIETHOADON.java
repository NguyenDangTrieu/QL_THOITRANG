...
public class GUI_CREATE_CHITIETHOADON extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CREATE DATA FROM CHI TIET HOA DON");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            String sql = "{ call PROC_INSERT_ChiTietHoaDon(?, ?, ?, ?, ?) }";
            cs = con.prepareCall(sql);
            cs.setString(1, txtMaHD.getText());
            cs.setString(2, txtMaSP.getText());
            cs.setString(3, txtGiaBan.getText());
            cs.setString(4, txtSoLuong.getText());
            cs.setString(5, txtThanhTien.getText());
            cs.execute();
