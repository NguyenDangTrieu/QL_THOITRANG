...
public class UI_Audit_Policy extends javax.swing.JPanel {
    ...
    public static void getAuditTrailReport(JTable table) {
        ...
        try (CallableStatement cstmt = connection.prepareCall("{call sys.Proc_GetAuditTrail(?)}")) {
            ...
            JOptionPane.showMessageDialog(null, "An error occurred while retrieving audit trail data: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void loadDBUsers() {
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "An error occurred while loading DB users: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void loadObjectNames() {
        try {
            ...
            // Handle SQL exception
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "An error occurred while loading object names: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
