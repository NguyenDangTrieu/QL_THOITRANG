...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new MODEL_Menu("2", "DataSpaces", MODEL_Menu.MenuType.MENU));
        listMenu1.addItem(new MODEL_Menu("3", "Session", MODEL_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new MODEL_Menu("7", "Policy", MODEL_Menu.MenuType.MENU));
        listMenu1.addItem(new MODEL_Menu("8", "Register", MODEL_Menu.MenuType.MENU));
